...
CREATE TABLE `message`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '留言时间',
...
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES (1, '111', 11, '11', '2022-09-06 00:00:00', 1);
INSERT INTO `message` VALUES (2, '12334', 1, 'admin', '2022-09-06 20:06:37', NULL);
INSERT INTO `message` VALUES (3, '22131321', 1, 'admin', '2022-09-06 20:07:36', NULL);
...
INSERT INTO `sys_menu` VALUES (4, '系统管理', NULL, 'el-icon-s-grid', NULL, NULL, NULL, 99999);
...
INSERT INTO `sys_menu` VALUES (11, '留言管理', '/message', 'el-icon-menu', NULL, NULL, 'Message', 999);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'admin', '管理员', 'admin@qq.com', '13988997788', '安徽合肥', '2022-01-22 21:10:27', 'http://localhost:9090/file/a2d2da19bde9429c96d2e627b0f03a64.jpg', 'ROLE_ADMIN');
...
INSERT INTO `sys_user` VALUES (4, 'haha', '123', 'haha', NULL, NULL, NULL, '2022-05-23 19:51:13', NULL, 'ROLE_USER');
INSERT INTO `sys_user` VALUES (6, 'xiaobai', '123', 'xiaobai', NULL, NULL, NULL, '2022-05-23 20:09:04', NULL, 'ROLE_USER');
INSERT INTO `sys_user` VALUES (7, 'uniapp', '123', 'uniapp', NULL, NULL, NULL, '2022-05-23 20:21:17', NULL, 'ROLE_USER');
